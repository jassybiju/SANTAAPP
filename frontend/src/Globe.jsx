...
const GlobeDisplay = () => {
  ...
  useLayoutEffect(() => {
    const measureParent = () => {
        console.log(globeEl.current.parentElement)
  ...
  useEffect(() => {
    ...
    // load data
    fetch("../public/world_population.csv")
      .then((res) => res.text())
      .then((csv) =>
